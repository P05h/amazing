...
if(window == top){
    var x = window.open();
  x.document.write('<iframe src="' + location.href + '" style="border:hidden;overflow:hidden;position:absolute;top:0;left:0%;bottom:0%;right:0%;width:100%;height:100%;"></iframe>');
  location.href="https://google.com/search?q=Math+help";
  }
    ...
    __uv.location = client.location.emulate(
        (href) => {
            ...
            if (href.startsWith('blob:')) href = href.slice('w:'.length);
